        ...
        <div class="hojapdf" id="reportepdf">
            <table width="100%" border="0">
                <tr>
                    ...
                    <td width="20%" align="center" valign="middle"><img src="../includes/logoumb.png"
                            alt="Universidad Mexiquense del Bicentenario" width="90%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" align="center" valign="middle">
                        <table width="100%" border="0">
                            <tr>
                                <td colspan="2" width="50%"><img src="../includes/graf1.jpg" alt="Grafica 1"
                                        width="90%"></td>
                                <td colspan="2" width="50%"><img src="../includes/graf2.jpg" alt="Grafica 3"
                                        width="90%"></td>
