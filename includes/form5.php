...
if (isset($_SESSION['id'])) {
    ...
    $sql = "SELECT * FROM `preguntas` INNER join Categoria_Pregunta on Categoria_Pregunta.id_cate_pre = preguntas.categoria WHERE preguntas.categoria = 5";
    $pre = mysqli_query($conexion, $sql);
    $sqlPre = "SELECT * FROM `preguntas` INNER join Categoria_Pregunta on Categoria_Pregunta.id_cate_pre = preguntas.categoria WHERE preguntas.categoria = 5";
...
?>
    ...
    $prom6 = ($p17 + $p18 + $p19 + $p20 + $p21 + $p22 +$p23) / 5;
    $prom7 = $prom5 + $prom6;
    $sqlinsert1 = "UPDATE encuesta_respuestas set P17=" . $p17 . ", P18=" . $p18 . ", P19=" . $p19 . ",  P20=" . $p20 . ",  P21=" . $p21 . ", P22=" .$p22.  ",P23=" . $p23 . "  where IdEncuestaRes=$idEncuestaRes";
            ...
            <main role="main" class="container">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="form6.php?Id_encuesta=<?php echo $id ?>" method="POST">
                            <table class="table table-primary  table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr> <input TYPE="HIDDEN" NAME="Prom7" value="<?= $prom7 ?>"></tr>
                                </tbody>
                            </table>
                            <div class="container">
